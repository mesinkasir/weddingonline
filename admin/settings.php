...
<div class="container">
	<div class="row">
	<div id="maincontent col-12 col-md-12 p-3 p-md-5">
		...
		<div class="main">
		<h4><?php i18n('WEBSITE_SETTINGS');?></h4>
		
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<p><label class="mdl-textfield__label" for="sitenameinput" >Website Title For SEO </label>
			<input class="text  mdl-textfield__input" id="sitenameinput" name="sitename" type="text" value="<?php if(isset($SITENAME1)) { echo stripslashes($SITENAME1); } else { echo stripslashes($SITENAME); } ?>" /></p>
		</div>
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<p><label class="mdl-textfield__label" for="siteurl" ><?php i18n('LABEL_BASEURL');?></label>
			<input class="text mdl-textfield__input" id="siteurl" name="siteurl" type="url" value="<?php if(isset($SITEURL1)) { echo $SITEURL1; } else { echo $SITEURL; } ?>" /></p>
		...
		<!--<h5><?php i18n('SIDE_USER_PROFILE');?></h5>-->
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<p><label class="mdl-textfield__label" for="user" ><?php i18n('LABEL_USERNAME');?></label>
			<input class="text mdl-textfield__input" id="user" name="user" type="text" readonly value="<?php if(isset($USR1)) { echo $USR1; } else { echo $USR; } ?>" /></p>
		</div>
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<p><label class="mdl-textfield__label" for="email" ><?php i18n('LABEL_EMAIL');?></label>
			<input class="text mdl-textfield__input" id="email" name="email" type="email" value="<?php if(isset($EMAIL1)) { echo $EMAIL1; } else { echo var_out($EMAIL,'email'); } ?>" /></p>
		...
		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<p><label class="mdl-textfield__label" for="name" ><?php i18n('LABEL_DISPNAME');?></label>
			<!--<?php i18n('DISPLAY_NAME');?>	-->
			<input class="text mdl-textfield__input" id="name" name="name" type="text" value="<?php if(isset($NAME1)) { echo $NAME1; } else { echo var_out($NAME); } ?>" /></p>
		</div>		

		<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<p><label for="timezone" class="mdl-textfield__label"><?php i18n('LOCAL_TIMEZONE');?>:</label>
			<!-- <?php if( (isset($_POST['timezone'])) ) { $TIMEZONE = $_POST['timezone']; } ?> -->
			<?php if( (isset($_POST['timezone'])) ) { $TIMEZONE = var_out($_POST['timezone']); } ?>
			<select class="text mdl-textfield__input" id="timezone" name="timezone"> 
		...
		<p style="margin:0px 0 5px 0;font-size:12px;color:#999;" ><?php i18n('ONLY_NEW_PASSWORD');?>:</p>
				<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<p><label for="sitepwd" class="mdl-textfield__label"><?php i18n('NEW_PASSWORD');?>:</label>
			<input autocomplete="off" class="text mdl-textfield__input" id="sitepwd" name="sitepwd" type="password" value="" /></p>
		</div>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
			<p><label for="sitepwd_confirm" class="mdl-textfield__label"><?php i18n('CONFIRM_PASSWORD');?>:</label>
			<input autocomplete="off" class="text mdl-textfield__input" id="sitepwd_confirm" name="sitepwd_confirm" type="password" value="" /></p>
		</div>
	
		
		<p id="submit_line" >
			<span><input class="submit  mdl-button mdl-js-button mdl-button--raised mdl-button--colored bg-danger text-white" type="submit" name="submitted" value="<?php i18n('BTN_SAVESETTINGS');?>" /></span> &nbsp;&nbsp;<?php i18n('OR'); ?>&nbsp;&nbsp; <a class="cancel  mdl-button mdl-js-button mdl-button--raised mdl-button--colored bg-dark text-white" href="settings.php?cancel"><?php i18n('CANCEL'); ?></a>
		</p>
