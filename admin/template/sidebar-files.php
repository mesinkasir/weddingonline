...
<div class="container">
<div class="row">
<div class="col-12 col-md-12 p-3 p-md-5 bg-light rounded">
<a href="upload.php" <?php check_menu('upload');  ?>><?php i18n('FILE_MANAGEMENT');?></a>
	<?php if(isset($_GET['i']) && $_GET['i'] != '') { ?>
	<a href="#" class="current"><?php i18n('IMG_CONTROl_PANEL');?></a><?php } ?>
